...
<xsl:stylesheet version="2.0"
    ...
    <xsl:template match="/">
        ...
        <div id="content">
            <h1>XML Sitemap</h1>
            <p class="expl">
                Generated by <a href="https://validio.de/">validIO</a>, this is an XML Sitemap, meant for consumption by search engines.<br/>
            ...
            <xsl:if test="count(sitemap:sitemapindex/sitemap:sitemap) &lt; 1">
                ...
                <p class="expl"><a href="{{$sitemap_index_url}}">&#8593; {{$sitemap_index_name}}</a></p>
